...
| `viking_ship`     | Aboard a massive viking longship in a storm |

## Files per level
- `backgrounds/<level>/bg_1.png … bg_3.png` — 400×224 parallax backdrops (3 seeds).
- `backgrounds/<level>/_sheet.png` — review contact sheet.
